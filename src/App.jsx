        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[9999] flex items-center justify-center p-2 md:p-8 animate-in fade-in duration-300">
          {viewMode === 'candidates' ? (
            <div className={`bg-gray-100 rounded-xl shadow-2xl w-full max-w-4xl h-full max-h-[95vh] flex flex-col overflow-hidden relative border border-white/20 ${isClosingList ? 'animate-modal-shrink' : 'animate-modal-pop'}`}>
              <div className="bg-[#b81d1d] text-white p-4 sm:p-5 flex items-start gap-3 sm:gap-4 relative shrink-0">
                <div className="mt-1 w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-yellow-400 bg-[#d92626] flex items-center justify-center shrink-0 shadow-sm">
                ...
                <div className="flex-1 pr-12 min-w-0">
                  <div className="flex items-center gap-1.5 sm:gap-2 mb-1.5">
                    ...
                    <p className="text-yellow-400 text-[10px] sm:text-xs font-bold uppercase tracking-wider leading-snug">
                      {detailedStation.don_vi_bau_cu} ({detailedStation.phuong_xa_cu})
                    </p>
                    <span className="w-4 sm:w-8 h-[1px] bg-yellow-400 shrink-0"></span>
                  </div>
                  <h2 className="text-lg sm:text-xl font-bold uppercase mb-1 leading-tight">Danh sách ứng cử viên</h2>
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl h-full max-h-[95vh] flex flex-col overflow-hidden relative border border-white/20 animate-in fade-in zoom-in-95 duration-300">
              <div className="bg-[#b83332] text-white p-4 sm:p-6 flex items-start gap-3 sm:gap-4 shrink-0 relative border-b-2 border-[#fbbf24]">
                <div className={`mt-1 w-10 h-10 sm:w-14 sm:h-14 bg-[#b83332] rounded-full border-2 border-[#fbbf24] flex items-center justify-center shrink-0 shadow-lg`}>
                ...
                <div className="flex-1 min-w-0 pr-2 sm:pr-4">
                  <div className="flex items-center gap-1.5 sm:gap-2 mb-1.5">
                    ...
                    <p className="text-[#fbbf24] text-[10px] sm:text-xs font-bold uppercase tracking-wider leading-snug">
                      {detailedStation.don_vi_bau_cu} ({detailedStation.phuong_xa_cu})
                    </p>
                    <span className="w-4 sm:w-8 h-[1px] bg-[#fbbf24] shrink-0"></span>
                  </div>
                  <h2 className="text-lg sm:text-xl font-bold leading-tight uppercase tracking-tight mb-1">{detailedStation.ten_diem}</h2>
                  <p className="text-xs sm:text-sm font-medium text-white/90 uppercase leading-snug">Tại {detailedStation.dia_chi_moi}</p>
                </div>
                <button onClick={handleCloseModal} className="p-1.5 bg-white/10 hover:bg-white/30 rounded-full transition shrink-0 mt-0.5"><X className="w-5 h-5 sm:w-6 sm:h-6" /></button>
              </div>
